...
public:
	...
	virtual void GetSurroundingObjects(D3DXVECTOR3 position, GameplayObject* &background, std::unordered_set<StandableObject*> &platforms, std::list<Monster*> &monsters) override;
